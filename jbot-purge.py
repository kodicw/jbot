...
def purge_directives(dir_path=".jbot/directives", archive_path=".jbot/directives/archive"):
    ...
    dir_files = [f for f in os.listdir(dir_path) if f.endswith((".txt", ".md")) and f != "README.md"]
            ...
            with open(df_path, "r") as f:
                ...
                if content_exp_match:
                    ...
                    if today > exp_date_from_filename:
                        is_expired = True
                        log(f"Directive {df} has expired (from filename: {exp_date_from_filename}).")
                ...
                if is_expired:
                    ...
                    log(f"Archived expired directive: {df} -> {os.path.basename(dest_path)}")
                    purged_count += 1
...
if __name__ == "__main__":
    ...
    parser.add_argument("-d", "--dir", default=".jbot/directives", help="Directives directory")
    parser.add_argument("-a", "--archive", default=".jbot/directives/archive", help="Archive directory")
